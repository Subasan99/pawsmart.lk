...
console.log('objectparamsparamsparams',params)
  ...
  return (
    <div id="hospital" className="pb-8 pt-20">
      ...
      <div style={{ border: '1px solid #ddd', padding: '16px', borderRadius: '8px', display: 'flex', maxWidth: '600px' }}>
        <div style={{ position: 'relative' }}>
          <img src="hospital.jpg" alt="Hospital Building" style={{ width: '150px', height: 'auto', borderRadius: '8px' }} />
          <span style={{ position: 'absolute', top: '8px', left: '8px', backgroundColor: 'red', color: 'white', padding: '4px 8px', borderRadius: '50%', fontWeight: 'bold' }}>⚡</span>
        </div>
        ...
        {/* <h2 style={{ fontSize: '1.5em', margin: '0' }}>Hospital
          ...
          <h2 style={{ fontSize: '1.5em', margin: '0' }}>{'hospitals.label' }
          ...
          <p style={{ margin: '12px 0', color: '#555' }}>
            Amet consectetur adipisicing eliteiuium sete eiu tempor incidit utoreas...
          </p>

    ...
    <RootLayout pageName="Anatolian Shepherd">
      <div className="grid grid-cols-1 lg:grid-cols-3 min-h-screen bg-gray-150 pb-10 my-450 overflow-y-auto bg-gray-50">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col lg:flex-row items-start lg:items-center justify-center bg-gray-150 min-h-full">
          <div className="pb-10 pt-6 pr-2 lg:pl-40 pl-2 min-h-full flex flex-col justify-between w-full">
            <Image
              src="/doctor.png"
              alt="Company Logo"
              width={690}
              height={460}
              className="mt-20 mb-5 w-full lg:w-auto"
            />
            <div>
              ...
              <ReviewSection
                message="It’s the first vaccine which is absolutely must be applied to every healthy cat that is 2 months."
                reviewDate="07-08-2022"
                signUpLink="/signup"
                rating={parseInt(rating, 10) || 0}
                reviewContent="It’s the first vaccine which is absolutely must be applied to every healthy cat that is 2 months. It’s the first vaccine which is absolutely must be applied to every healthy cat that is 2 months."
        ...
        <div className="col-span-1 flex  lg:pr-40 lg:my-0 my-8 mx-6 min-h-screen relative bottom-0">

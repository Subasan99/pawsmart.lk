...
// const PopularDoctors = dynamic(() => import('@/components/Image'), {
//   loading: () => <div className="animate-pulse bg-gray-200 h-64 rounded-lg"></div>,
//   ssr: false
// });

// const SpecialistCard = dynamic(() => import('@/components/HomeComponent/doctorcard'), {
//   loading: () => <div className="animate-pulse bg-gray-200 h-64 rounded-lg"></div>,
//   ssr: false
// });

// const ServiceCard = dynamic(() => import('@/components/HomeComponent/ServiceCard'), {
//   loading: () => <div className="animate-pulse bg-gray-200 h-32 rounded-lg"></div>,
//   ssr: false
// });

// const AdvancedSearchFilter = dynamic(() => import('@/components/HomeComponent/AdvancedSearchFilter'), {
//   loading: () => <div className="animate-pulse bg-gray-200 h-48 rounded-lg"></div>,
//   ssr: false
// });

// // Import necessary stores and actions
// import { useDoctorStore } from '@/store/doctorStore';
// import { useAuthStore } from '@/store/authStore';
// import { useDepartmentStore } from '@/store/departmentStore';
// import { useSpecializationStore } from '@/store/specializationStore';
...
//         {/* Keep the existing structure with lazy loaded components */}
